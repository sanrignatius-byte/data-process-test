...
\title{Averaging Gone Wrong: Using Time-Aware Analyses to Better Understand Behavior\footnote{A final version of this work was published in the Proceedings of the 25th International Conference on World Wide Web (WWW'16). It can be found in \url{http://dx.doi.org/10.1145/2872427.2883083}.}}
...
\begin{figure*}[!tb]
\centering
\subimage[width=0.48, scale=0.40]{images/cumulative_users_subreddits-eps-converted-to.pdf}
\subimage[width=0.48, scale=0.40]{images/active_users_subreddits-eps-converted-to.pdf}
...
\begin{figure*}[!tb]
\centering
\subimage[width=0.48, scale=0.40]{images/avr_posts_per_user_over_time_total-eps-converted-to.pdf}
\subimage[width=0.48, scale=0.40]{images/avr_posts_per_user_user_ref_total-eps-converted-to.pdf}
...
\begin{figure*}[!tb]
\centering
\subimage[width=0.48, scale=0.42]{images/avr_posts_per_user_over_time_cohorts-eps-converted-to.pdf}
\subimage[width=0.48, scale=0.42]{images/avr_posts_per_user_cohorts-eps-converted-to.pdf}
...
\begin{figure*}[!tb]
\centering
\subimage[width=0.31, scale=0.29]{images/avr_posts_per_user_for_surviving_year_for_2010-eps-converted-to.pdf}{2010 cohort}
\subimage[width=0.31, scale=0.29]{images/avr_posts_per_user_for_surviving_year_for_2011-eps-converted-to.pdf}{2011 cohort}
\subimage[width=0.31, scale=0.29]{images/avr_posts_per_user_for_surviving_year_for_2012-eps-converted-to.pdf}{2012 cohort}
...
\begin{figure*}[!tb]
\centering
\subimage[width=0.48, scale=0.42]{images/avr_comment_size_over_time_cohorts-eps-converted-to.pdf}
\subimage[width=0.48, scale=0.42]{images/avr_comment_size_cohorts-eps-converted-to.pdf}
\subimage[width=0.31, scale=0.29]{images/avr_comment_length_for_surviving_year_for_2010-eps-converted-to.pdf}{2010 cohort}
\subimage[width=0.31, scale=0.29]{images/avr_comment_length_for_surviving_year_for_2011-eps-converted-to.pdf}{2011 cohort}
\subimage[width=0.31, scale=0.29]{images/avr_comment_length_for_surviving_year_for_2012-eps-converted-to.pdf}{2012 cohort}
...
\begin{figure*}[!tb]
\centering
\subimage[width=0.48, scale=0.42]{images/comments_per_submissions_over_time_cohorts-eps-converted-to.pdf}
\subimage[width=0.48, scale=0.42]{images/comments_per_submissions_cohorts-eps-converted-to.pdf}
\subimage[width=0.23, scale=0.23]{images/comments_per_submissions_for_surviving_year_for_2008-eps-converted-to.pdf}{2008 cohort}
\subimage[width=0.23, scale=0.23]{images/comments_per_submissions_for_surviving_year_for_2009-eps-converted-to.pdf}{2009 cohort}
\subimage[width=0.23, scale=0.23]{images/comments_per_submissions_for_surviving_year_for_2010-eps-converted-to.pdf}{2010 cohort}
\subimage[width=0.23, scale=0.23]{images/comments_per_submissions_for_surviving_year_for_2011-eps-converted-to.pdf}{2011 cohort}
