...
(b) Figure 5: t-SNE (van der Maaten, 2013) visualizations of the Extended Yale B training set. (a): original x , (b): latent $\mathbf { z } _ { 1 }$ from VFAE. Each example is plotted with the person ID and the image. Zoom in to see details.
...
1. Figure 5: t-SNE (van der Maaten, 2013) visualizations of the Extended Yale B training set.
