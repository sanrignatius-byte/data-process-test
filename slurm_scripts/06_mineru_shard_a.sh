...
#SBATCH --output=logs/mineru_shardA_%j.out
#SBATCH --error=logs/mineru_shardA_%j.err

# ============================================================================
# MinerU Shard A — gpu-a40-1, 4× A40 GPU
# Parses first half of PDFs (711 files)
# ============================================================================

set -euo pipefail

SHARD_NAME="A"
SHARD_FILE="/projects/myyyx1/data-process-test/logs/shard_a.txt"
NUM_GPUS=4
